...
if (isset($_SESSION["driver_id"])){
    ...
    $exp_driver =  $driver["experience"];

    $drivingLevelCurrent = handleLevelCurrentProfile($exp_driver);
}
...
function handleLevelCurrentProfile($exp2){
    $level = ""; 
    $color = "";
    ...
    if($exp2 == 1) {
        ...
        $level = "Beginner";
        $color = "rgb(255, 0, 55)"; // Light Pink
    } elseif($exp2 > 2 && $exp2 <= 5) {
        $level = "Intermediate";
        $color = "rgb(140, 109, 213)"; // Light Violet
    } elseif($exp2 > 5 && $exp2 <= 10) {
        $level = "Proficient";
        $color = "#6c36d7"; // Dark Violet
    } elseif($exp2 > 10 && $exp2 <= 15) {
        $level = "Experienced";
        $color = "rgb(4,181,194)"; // Primary Color
    } elseif($exp2 > 15 && $exp2 <= 20) {
        $level = "Seasoned";
        $color = "#800080"; // Purple
    } elseif($exp2 > 20 && $exp2 <= 30) {
        $level = "Expert";
        $color = "rgba(211, 32, 56, 0.863)"; // Pink
    } elseif($exp2 > 30) {
        $level = "Veteran";
        ...
        <nav>
            ...
            <div class="menu-container">
                 <div class="info-top-div">
                    <p class="name-header"><?= htmlspecialchars($driver["name"]) ?></p><br>
                    <p class="level-header" style="color: <?php echo $drivingLevelCurrent['color']; ?>">
                        <?php echo $drivingLevelCurrent['level']; ?>
                    </p>
                </div>
